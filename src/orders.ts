...
export function getOrdersFromTip (): TRADE_TRANS_INFO[] {
...
export async function getOrdersFromPrice (getTickPrices: Function, error: Function): Promise<TRADE_TRANS_INFO[]> {
